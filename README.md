...
Note: In Python notebook only Mac and Linux users will NOT be able to clone and run the example because __data.table__ is not available for Windows users.
